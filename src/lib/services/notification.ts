...
const notificationCopy: Record<ReviewNotificationKind, { title: string; body: string }> = {
  inline: {
...
export async function notifyReviewComplete(kind: ReviewNotificationKind): Promise<void> {
